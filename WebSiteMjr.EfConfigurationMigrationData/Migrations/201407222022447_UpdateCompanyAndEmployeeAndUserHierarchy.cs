namespace WebSiteMjr.EfConfigurationMigrationData.Migrations
{
    ...
    public partial class UpdateCompanyAndEmployeeAndUserHierarchy : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("CREATE TABLE Migration ( IdHolder int, EmailHolder char(100), CONSTRAINT [PK_Source] PRIMARY KEY CLUSTERED (IdHolder DESC) ) Insert Into Migration (IdHolder, EmailHolder) Select Id, Email From Companies ");
